...
export const buildModelMessages = (
  ...
  const system = [
    ...
    'Use native tools when the user explicitly asks to publish an existing drafted issue or asks Daifu to stop an active execution.',
    'Do not start Architect, Tester, or Coder from normal chat. The Python backend presents stage approval cards and starts exactly one approved next stage.',
