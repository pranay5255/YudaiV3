...
export const LoginPage: React.FC = () => {
  ...
  const stepAccentClasses: Record<string, string> = {
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-3 space-y-10">
            ...
            {/* How It Works */}
            <div>
              <h2 className="text-sm font-mono text-text-muted uppercase tracking-wider mb-6">How it works</h2>
                ...
                {[
                  ...
                  <div key={item.step} className="flex gap-5">
                    <div className="flex-shrink-0">
                      <span
                        className={`inline-flex items-center justify-center w-10 h-10 rounded-lg border font-mono text-sm ${stepAccentClasses[item.color]}`}
                      >
                        {item.step}
                      </span>
                    </div>
          ...
          <div className="lg:col-span-2">
            <div className="lg:sticky lg:top-8">
              <div className="rounded-xl bg-bg-secondary border border-border p-6 sm:p-8 shadow-2xl shadow-black/20">
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-sm font-medium text-text-primary">Sign in with GitHub</span>
                  </div>

                  <button
                    onClick={handleGitHubLogin}
                    disabled={isLoading}
                    className="w-full bg-text-primary hover:bg-white disabled:bg-text-secondary text-bg-primary font-medium py-3.5 px-6 rounded-lg transition-all duration-200 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl hover:-translate-y-0.5 disabled:translate-y-0 disabled:shadow-lg"
                  >
                    {isLoading ? (
                      <>
                        <div className="animate-spin rounded-full h-5 w-5 border-2 border-bg-primary/20 border-t-bg-primary" />
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-sm font-medium text-text-primary">Install GitHub App</span>
                  </div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center w-full rounded-lg border border-border bg-bg-tertiary hover:bg-bg-secondary px-6 py-3 text-sm font-medium text-text-primary transition-colors"
                  >
                    Install GitHub App
                  </a>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2.5 w-full bg-discord/10 hover:bg-discord/20 border border-discord/20 text-text-primary font-medium py-3 px-6 rounded-lg transition-colors"
                >
