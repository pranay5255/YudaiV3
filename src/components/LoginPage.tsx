...
const HERO_PILLS = [
  'Governed planning',
  'Coverage-first testing',
  'Review-ready delivery',
] as const;

const HERO_HIGHLIGHTS = [
  {
    label: 'Repo-scoped runtime',
    description: 'Keep execution isolated by org, repo, and environment.',
  },
  {
    label: 'Live trajectory view',
    description: 'Watch planning, testing, and delivery as the workflow advances.',
  },
  {
    label: 'Audit-ready trail',
    description: 'Trace requirements, tests, implementation, and review artifacts in one place.',
  },
] as const;
...
const WORKFLOW_STEPS = [
  {
    step: '01',
    title: 'Plan',
    description: 'Architect mode converts requirements into a scoped issue with clear acceptance criteria.',
    color: 'cyan',
  },
  {
    step: '02',
    title: 'Test',
    description: 'Tester mode writes coverage-first validation before implementation begins.',
    color: 'blue',
  },
  {
    step: '03',
    title: 'Deliver',
    description: 'Coder mode implements the work, validates it, and prepares a review-ready pull request.',
    color: 'emerald',
  },
] as const;
...
const CAPABILITY_CARDS = [
  {
    ...
    description: 'Architect, Tester, and Coder work through explicit checkpoints instead of opaque automation.',
  },
  {
    title: 'GitHub-native control',
    description: 'Use your existing repository, review, and app-installation workflow without a parallel toolchain.',
  },
  {
    title: 'Operational visibility',
    description: 'Track issue creation, test generation, and PR delivery with live updates and clear status transitions.',
  },
  {
    title: 'Traceable artifacts',
    description: 'Keep the issue, tests, implementation, and final review output connected for later audits.',
  },
] as const;
...
const AUTH_BULLETS = [
  ...
  'Traceable execution with live status and logs',
] as const;

const FOOTER_PILLARS = [
  'Repo-scoped isolation',
  'Coverage-first validation',
...
const BrandLockup = () => (
  <div className="relative isolate aspect-[14/5] w-[220px] overflow-hidden rounded-[26px] border border-white/10 bg-[#051425] shadow-[0_24px_60px_rgba(0,0,0,0.35)] sm:w-[260px]">
...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-bg-primary text-text-primary selection:bg-sky-400/20">
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_bottom,rgba(4,11,22,0.96),rgba(10,10,11,0.98))]" />
      ...
      <div className="pointer-events-none absolute left-[-5rem] top-20 h-72 w-72 rounded-full bg-cyan-400/10 blur-3xl" />
      <div className="pointer-events-none absolute right-[-6rem] top-24 h-80 w-80 rounded-full bg-emerald-400/10 blur-3xl" />

      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <section className="border-b border-white/10 pb-16 pt-8 sm:pb-20 sm:pt-10 lg:pb-24 lg:pt-14">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.08fr)_minmax(360px,420px)] lg:items-start xl:gap-16">
            <div className="max-w-2xl space-y-8">
              ...
              <div className="inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-xs font-medium uppercase tracking-[0.24em] text-text-secondary backdrop-blur-sm">
                ...
                governed delivery for GitHub teams
              </div>

              <div className="space-y-5">
                <h1 className="max-w-[13ch] text-[clamp(2.5rem,5vw,4.25rem)] font-semibold leading-[1.02] tracking-[-0.045em] text-white">
                  Move from requirements to review-ready pull requests without losing control.
                </h1>

                <p className="max-w-xl text-base leading-7 text-text-secondary sm:text-lg sm:leading-8">
                  YudaiV3 plans work, writes coverage-first tests, and executes inside repo-scoped
                  sandboxes with live trajectory visibility for engineering teams.
                </p>
              </div>
            ...
            <div className="rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,17,29,0.94),rgba(6,10,19,0.9))] p-6 shadow-[0_30px_80px_rgba(0,0,0,0.35)] backdrop-blur-md sm:p-8">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 max-w-sm text-sm leading-6 text-text-secondary">
                    Connect GitHub once, install the app, and launch governed Architect, Tester, and
                    Coder workflows from your repository.
                  </p>
                </div>
              ...
              <div className="mt-6 rounded-[24px] border border-cyan-400/15 bg-cyan-400/5 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-text-secondary">
                  Authenticate with GitHub first, then install the app to grant repository access.
                </p>
              </div>
              ...
              {errorMessage && (
                <div
                  role="alert"
                  className="mt-6 rounded-[20px] border border-red-500/25 bg-red-500/10 p-4"
                >
              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-[24px] border border-white/10 bg-black/20 p-4">
                  <div className="flex items-start gap-3">
                    <span className="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full border border-cyan-400/20 bg-cyan-400/10 text-xs font-mono text-cyan-300">
                      1
                    </span>
                    <div className="min-w-0 flex-1">
                      <p className="text-sm font-semibold text-white">Sign in with GitHub</p>
                      <p className="mt-1 text-sm leading-6 text-text-secondary">
                        Authenticate your account to begin a governed session.
                      </p>
                    </div>
                  </div>
                ...
                <div className="rounded-[24px] border border-white/10 bg-black/20 p-4">
                  <div className="flex items-start gap-3">
                    <span className="mt-0.5 flex h-8 w-8 items-center justify-center rounded-full border border-emerald-400/20 bg-emerald-400/10 text-xs font-mono text-emerald-300">
                      2
                    </span>
                    <div className="min-w-0 flex-1">
                      <p className="text-sm font-semibold text-white">Install GitHub App</p>
                      <p className="mt-1 text-sm leading-6 text-text-secondary">
              ...
              <div className="mt-6 space-y-3 rounded-[24px] border border-white/10 bg-black/20 px-4 py-5">
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.04em] text-white sm:text-4xl">
              See the issue-to-tests-to-PR handoff before you connect GitHub.
            </h2>
            <p className="mt-4 text-base leading-7 text-text-secondary sm:text-lg sm:leading-8">
              The preview shows how YudaiV3 plans implementation, generates tests, and opens a
              review-ready pull request with full trajectory visibility.
            </p>
          </div>

          <div className="mx-auto mt-8 max-w-6xl rounded-[34px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,17,29,0.94),rgba(6,10,19,0.9))] p-4 shadow-[0_30px_90px_rgba(0,0,0,0.4)] sm:p-5">
            <div className="overflow-hidden rounded-[28px] border border-white/10 bg-black shadow-[0_28px_70px_rgba(0,0,0,0.42)]">
              <video
                autoPlay
                muted
                loop
        ...
        <section className="grid gap-6 pb-16 sm:pb-20 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
          <div className="rounded-[32px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.24)] backdrop-blur-sm sm:p-8">
            ...
            <h2 className="mt-3 max-w-lg text-3xl font-semibold tracking-[-0.04em] text-white">
              A readable path from planning to merged work
            </h2>
          ...
          <div className="rounded-[32px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.24)] backdrop-blur-sm sm:p-8">
            ...
            <h2 className="mt-3 max-w-lg text-3xl font-semibold tracking-[-0.04em] text-white">
              Enterprise controls without visual clutter
            </h2>
