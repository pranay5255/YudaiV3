...
class IssueService:
    ...
    async def generate_issue_from_context(
        ...
        try:
            ...
            try:
                from yudai.models import ChatSession as _ChatSession
    ...
    def _build_issue_generation_prompt(
        ...
        prompt_parts = [
            ...
            "   - Implementation plan (ordered list; concrete edits with file paths; include fallback discovery e.g. `npm search onchainkit` if package unclear)",
            ...
            "3) When suggesting installs or commands, use repo-native tooling (npm in this repository) and include non-interactive flags.",
        ...
        prompt_parts.extend(
            [
                ...
                "- Prefer repo-native tooling (npm in this repository).",
