...
class RealtimeLifecycleService:
    ...
    def __init__(
        ...
        *,
        ...
        self.default_org = get_sandbox_config().default_org
...
class SandboxManager:
    ...
    def __init__(self):
        sandbox_config = get_sandbox_config()
        self.probe_interval_seconds = sandbox_config.liveness_interval_seconds
        self.probe_timeout_seconds = sandbox_config.liveness_timeout_seconds
        self.git_fetch_interval_seconds = sandbox_config.git_fetch_interval_seconds

        self.tunnel_template = (
            sandbox_config.tunnel_template or "http://localhost:8100/{sandbox_id}"
        )

        self.repo_root = Path(sandbox_config.git_root)
